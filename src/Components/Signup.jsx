    ...
    return (<div> <div className='bg-black'>
        <div className='w-120 relative top-20 left-100 border border-gray-700 shadow-[0.5px_0.5px_8px_white] bg-black rounded-lg'>
            ...
            <div className='flex flex-col p-2'>
                ...
                <input type="text" placeholder='About Your Channel' value={aboutChannel} onChange={(e)=>setAboutChannel(e.target.value)} className='w-100 bg-gray-800 text-white p-2 m-4 rounded-md outline-none'/>
